    ...
    return BlocProvider(
      ...
      child: BlocConsumer<FirebaseAuthCubit, FirebaseAuthState>(
        builder: (BuildContext context, state) {
          ...
          if(state is LogInError){return Center(child: Text(state.errorMessage.toString(),style: TextStyle(color: Colors.red),),);}
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: ()async{
                            await context.read<FirebaseAuthCubit>().logIn(email.text.trim(), password.text.trim());
                              },
